...
class UpsSaleOrder(models.Model):
    ...
    def location_api_request_data(self):
        ...
        etree.SubElement(master_node_AccessRequest, 'AccessLicenseNumber').text = "{}".format(
        ...
        etree.SubElement(sub_root_node_Request, "RequestOption").text = "{}".format(
            self.carrier_id and self.carrier_id.ups_request_option)
        ...
        etree.SubElement(sub_root_node_AddressKeyFormat, 'PoliticalDivision2').text = "{}".format(
            recipient_address.city)
        etree.SubElement(sub_root_node_AddressKeyFormat, 'PoliticalDivision1').text = "{}".format(
            recipient_address.state_id.code)
        ...
        etree.SubElement(sub_root_node_UnitOfMeasurement, 'Code').text = "{}".format(
            self.carrier_id and self.carrier_id.ups_measurement_code)
        ...
        etree.SubElement(sub_root_node_ServiceCode, 'Code').text = "{}".format(
            self.carrier_id and self.carrier_id.ups_service_code)
